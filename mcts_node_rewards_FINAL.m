classdef mcts_node_rewards_FINAL < handle
    ...
    methods
        function obj = mcts_node_rewards_FINAL(x,sigma,softmaxScale,maxUsersPerCluster,maxIter,step,sinr_threshold,maxSigma,numberOfUsers,desiredLinkReliability,parentMerit)
            ...
            obj.maxIter = maxIter;
            obj.max_allocation_score = mcts_node_rewards_FINAL.getMaxAllocationScore();
            obj.max_efficiency_score = mcts_node_rewards_FINAL.getMaxEfficiencyScore();
            ...
            if obj.num_childs == 0
                for i = 1:size(obj.sigma,2)
                    ...
                    if index ~= 0
                        ...
                        obj.childs{obj.num_childs} = mcts_node_rewards_FINAL(x,sigma_to_explore,obj.softmaxScale,...
