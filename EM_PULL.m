function [allocationScore,reliabilityScore,sigma] = EM_PULL (x,m,sigmaScale,sigmaMax,softmaxScale,maxUsersPerCluster,maxIter,SINR_THRESHOLD)
...
%         Tx=T.*sigmaScale;
        ...
        elseif usersPerCluster(j) > maxUsersPerCluster && sigma(1,1,j) > sigmaMin
