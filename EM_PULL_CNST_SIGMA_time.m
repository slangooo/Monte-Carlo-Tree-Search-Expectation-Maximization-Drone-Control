function [ efficiencyScore,allocationScore,reliabilityScore, maxSINR, numberOfServedUsers,iter,mu] = EM_PULL_CNST_SIGMA_time (x,m,sigma_in,softmaxScale,maxUsersPerCluster,maxIter,sinr_threshold)
