classdef TP_MCTS < handle
    ...
    methods
        function obj = TP_MCTS(x,sigma,softmaxScale,maxUsersPerCluster,maxIter,step,sinr_threshold,maxSigma,numberOfUsers,desiredLinkReliability,parentMerit)
            ...
            obj.maxIter = maxIter;
            obj.max_allocation_score = TP_MCTS.getMaxAllocationScore();
            obj.max_efficiency_score = TP_MCTS.getMaxEfficiencyScore();
            ...
            if obj.num_childs == 0
                for i = 1:size(obj.sigma,2)
                    ...
                    if index ~= 0
                        ...
                        obj.childs{obj.num_childs} = TP_MCTS(x,sigma_to_explore,obj.softmaxScale,...
